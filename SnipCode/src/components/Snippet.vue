<template>
  <main>
    ...
    <div class="snippet-panel">
      ...
      <button class="btn-share" @click="shareSnippet()">
    ...
    <textarea :readonly="readonly" v-model="content"></textarea>
  </main>
</template>
<script>
export default {
  ...
  methods:
  {
    shareSnippet()
    {
      ...
      else
      {
        ...
        {
          this.$store.dispatch("uploadSnippetContent",{content: this.content}).then(result =>
          {
  ...
  mounted()
  {
    ...
    {
      this.$store.getters.snippetByHash(this.hash).then(result =>{
